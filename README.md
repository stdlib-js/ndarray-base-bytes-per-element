...
```javascript
bytesPerElement = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-bytes-per-element@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-bytes-per-element@v0.1.0-umd/browser.js"></script>
```
